							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								%>
									...
									<tr>
										...
										<td>
											<input type="text" id="name" name="name" value="<%=data.getTel()%>" title="관리자 이름을 입력해주세요." />
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="">주소/우편번호</label></th>
										<td>											
											<input type="text" id="addr" name="addr" value="<%=data.getAddr()%>" title="관리자 이름을 입력해주세요." />
									...
									<tr>
										...
										<td>
											<input type="text" id="name" name="name" value="<%=data.getAddr_detail()%>" title="관리자 이름을 입력해주세요." />
										</td>
									</tr>
