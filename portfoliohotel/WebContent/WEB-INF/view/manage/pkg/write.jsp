							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" id="enddate" name="enddatae" class="inputTitle" value=""/>&nbsp;
											<span id="CalstartdateIcon">
												<img src="/manage/img/calendar_icon.png" id="CalstartdateIconImg" style="cusor:pointer;"/>
											</span>
										</td>
									...
									<tr>
										...
										<td colspan="3">
											<input type="text" id="event" name="event" class="w20"/>
										</td>
									<tr>
										<th scope="row"><label for="">안내</label></th>
										<td colspan="3">
											<input type="text" id="guide" name="guide" class="w20"/>
										</td>
									</tr>
