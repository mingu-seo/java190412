        ...
        <div class="notice">
            <div class="support-list">
                <ul class="support-list-center">
                    <li class="on"><a href="find_id.html">이메일 찾기</a></li>
                ...
                <div class="edit-table">
                    ...
                    <div class="edit-table-right">
                        <form method="POST">
                            ...
                            <ul class="name" clear>
                                <li>
                                    <input type="text" id="fname" name="name" placeholder="성" maxlength="2">
                                </li>

                                <li>
                                    <input type="text" id="lname" name="name" placeholder="이름" maxlength="12">
                                </li>
